...
export const TOOLS: Tool[] = [
  ...
  { id: 'collage', href: '/collage', name: 'Интерьер коллажы', nameRu: 'Коллаж интерьера', description: 'Фонсыз заттар, қабаттар', descriptionRu: 'Предметы без фона, слои', icon: '🛋', category: 'doc', search: 'коллаж интерьер мудборд дизайнер мебель фон жою подборка myterior', badge: { text: 'ЖАҢА', type: 'new' }, glowClass: 'from-amber-400 to-rose-500', size: 'lg' },
...
export const SECTIONS = [
  ...
  { key: 'doc', label: 'ҚҰЖАТТАР МЕН ҚҰРАЛДАР', labelRu: 'ДОКУМЕНТЫ И УТИЛИТЫ', title: 'Генераторлар мен утилиталар', titleRu: 'Генераторы и утилиты', tools: ['pdf', 'collage', 'doctemplates', 'resume', 'qr', 'invoice', 'septik', 'passgen'] },
]
